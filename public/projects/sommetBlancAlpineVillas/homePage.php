    ...
    <nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav navbar-dark">
        ...
        <div class="d-flex change-mode">
        	...
        	<ul class="nav navbar-nav nav-flex-icons ml-auto" style="color:white">
			    ...
			    <li class="nav-item">
			        <a class="nav-link" data-type="projectmenu" data-filename='data'>Data</a>
		     	</li>
...
<style>
	.page-body {
		background-image:url("<?php echo ROOT . "/projects/sommetBlancAlpineVillas/sommetBlanc-2200.jpg";?>");
	}
</style>
